    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                splashWindow.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR); //  set status text dark
                splashWindow.setStatusBarColor(Color.parseColor(statusBarColor)); // set status background white
