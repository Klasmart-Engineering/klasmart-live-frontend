...
export const WebRTCProvider = (props: {children: React.ReactNode}) => {
    ...
    // const globalMuteMessage = (globalMuteNotification: GlobalMuteNotification): void => {
    //     setAudioGloballyMuted(globalMuteNotification.audioGloballyMuted ?? audioGloballyMuted);
    //     setVideoGloballyDisabled(globalMuteNotification.videoGloballyDisabled ?? videoGloballyDisabled);
    // }
