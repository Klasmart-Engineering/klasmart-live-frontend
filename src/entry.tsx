        ...
        if (isDebugMode) {
            ...
            return {
                ...
                materials: materialsParam ? JSON.parse(materialsParam) : [
                    ...
                    { __typename: MaterialTypename.Iframe, name: "Interactive book", url: "/h5p/play/608fb8ebfaaa390014c2fb71" },
                    { __typename: MaterialTypename.Iframe, name: "KLL-308", url: "/h5p/play/608bd68cd6378f00130bfa70" },
