...
const TABS = [
    ...
    { icon: <SettingsIcon role="img" size="1.5rem" />, title: "title_settings_live", userType: UserType.Both, classType: ClassType.LIVE }
];
    ...
    return (
        <Grid
            ...
            style={{
                ...
                backgroundColor: (classType === ClassType.LIVE ? "transparent" : "white")
            }}
        >
            <Grid
                ...
                >
                    <Grid item>
                        <StyledButton onClick={() => {
                            restart();
                        }}><FormattedMessage id="layout_tabinnercontent_leaveroom" /></StyledButton>
                    </Grid>
                </Grid>
            );
        default:
