...
const messages: Record<string, string> = {
    ...
    end_class_description: `Ending class will close the session window tab for all participants`,
    leave_class: `Leave Class`,
    leave_class_description: `Leaving class will close the session window tab, close your camera and turn off your microphone`,
