...
const messages: Record<string, string> = {
    ...
    notification_user_left: `{user}가 수업에서 나갔습니다.`,
    notification_user_muted_microphone: `{user}의 마이크가 꺼졌습니다.`,
    notification_user_muted_camera: `{user}의 카메라가 꺼졌습니다.`,
    notification_self_muted_user_microphone: `{user}의 마이크를 중단했습니다.`,
    notification_self_muted_user_camera: `{user}의 카메라를 중단했습니다.`,
    notification_self_muted_user_canvas: `{user}의 캔버스 기능을 중단했습니다.`,
    notification_self_muted_by_user_microphone: `{user}가 당신의 마이크를 중단했습니다.`,
    notification_self_muted_by_user_camera: `{user}가 당신의 카메라를 중단했습니다.`,
    notification_self_muted_by_user_canvas: `{user}가 당신의 캔버스 기능을 중단했습니다.`,
