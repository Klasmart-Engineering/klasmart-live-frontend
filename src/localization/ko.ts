...
const messages: Record<string, string> = {
    ...
    feedback_not_so_good: `매우 나쁨`,
    feedback_bad: `나쁨`,
    feedback_okay: `보통`,
    feedback_good: `좋음`,
    feedback_awesome: `매우 좋음`,
    ...
    feedback_detail_question: `상세한 의견을 남기시겠습니까?`,
    feedback_comment: `의견을 남겨 주세요`,

    feedback_end_class_student_video_1: `영상 질이 매우 낮음`,
    feedback_end_class_student_audio_1: `음향 질이 매우 낮음`,
    feedback_end_class_student_presentation_1: `교사의 화면을 볼 수 없음`,
    feedback_end_class_student_other_1: `그 외`,
    feedback_end_class_student_video_2: `영상 질이 낮음`,
    feedback_end_class_student_audio_2: `음향 질이 낮음`,
    feedback_end_class_student_presentation_2: `교사의 화면을 볼 때 문제가 있었음`,
    feedback_end_class_student_other_2: `그 외`,
    feedback_end_class_student_video_3: `영상의 질이 적절함`,
    feedback_end_class_student_audio_3: `음향의 질이 적절함`,
    feedback_end_class_student_presentation_3: `교사의 화면을 볼 때 문제가 있었음`,
    feedback_end_class_student_other_3: `그 외`,
    feedback_end_class_student_video_4: `영상의 질이 좋았음`,
    feedback_end_class_student_audio_4: `음향의 질이 좋았음`,
    feedback_end_class_student_presentation_4: `교사의 화면이 학습에 지장을 주지 않음`,
    feedback_end_class_student_other_4: `그 외`,
    feedback_end_class_student_video_5: `영상의 질이 훌륭함`,
    feedback_end_class_student_audio_5: `음향의 질이 훌륭함`,
    feedback_end_class_student_presentation_5: `교사 화면이 문제 없이 잘 작동하였음`,
    feedback_end_class_student_other_5: `그 외`,

    feedback_end_class_teacher_video_1: `영상 질이 매우 낮음`,
    feedback_end_class_teacher_audio_1: `음향 질이 매우 낮음`,
    feedback_end_class_teacher_presentation_1: `화면 발표 시 문제가 있었음`,
    feedback_end_class_teacher_other_1: `교사용 툴 사용 시 문제가 있었음`,
    feedback_end_class_teacher_video_2: `영상 질이 낮음`,
    feedback_end_class_teacher_audio_2: `음향 질이 낮음`,
    feedback_end_class_teacher_presentation_2: `화면 발표 시 문제가 있었음`,
    feedback_end_class_teacher_other_2: `교사용 툴 사용 시 문제가 있었음`,
    feedback_end_class_teacher_video_3: `영상의 질이 적절함`,
    feedback_end_class_teacher_audio_3: `음향의 질이 적절함`,
    feedback_end_class_teacher_presentation_3: `화면 발표 시 문제가 있었음`,
    feedback_end_class_teacher_other_3: `교사용 툴 사용 시 문제가 있었음`,
    feedback_end_class_teacher_video_4: `영상의 질이 좋았음`,
    feedback_end_class_teacher_audio_4: `음향의 질이 좋았음`,
    feedback_end_class_teacher_presentation_4: `화면 발표 시 문제가 없었음`,
    feedback_end_class_teacher_other_4: `교사용 툴 사용 시 문제가 없었음`,
    feedback_end_class_teacher_video_5: `영상의 질이 훌륭함`,
    feedback_end_class_teacher_audio_5: `음향의 질이 훌륭함`,
    feedback_end_class_teacher_presentation_5: `화면 발표 시 매우 잘 작동함`,
    feedback_end_class_teacher_other_5: `교사용 툴 사용 시 매우 잘 작동함`,

    loading_activity_lessonMaterial: `수업 재료를 불러오는 중입니다!`,
    loading_activity_lessonMaterial_description: `만약 {seconds}초 후에도 화면이 이동하지 않는다면, 아래의 새로고침 버튼을 눌러주세요.`,
    loading_activity_error: `죄송합니다. 오류가 발생하였습니다.`,
    loading_activity_lessonMaterial_clickReload: `새로고침 버튼을 줄러주세요.`,
    loading_activity_lessonMaterial_reload: `새로고침`,

    notification_user_joined: `{user}님이 교실에 입장하였습니다`,
    join_your_class: `교실에 입장하세요`,

    start: `시작`,
    end_study_exit: `스터디 나가기`,
    end_study_confirm: `이만 스터디 학습을 끝낼까요?`,
    end_study_bonus_content: `보너스 학습`,
};
