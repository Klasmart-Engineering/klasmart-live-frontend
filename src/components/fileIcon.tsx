...
const useStyles = makeStyles({
    ...
    badge_anchorOriginBottomRightRectangle: {
        right: 0,
        bottom: 0,
...
export function FileIcon(props: Props): JSX.Element {
    ...
    return (
        <Badge
            ...
            children={<InsertDriveFile fontSize="large" />}
            color="primary"
            classes={{
                colorPrimary: generateFileBadge(props.fileType ? props.fileType : ""),
                badge: classes.badge_text,
                anchorOriginBottomRightRectangle: classes.badge_anchorOriginBottomRightRectangle
            }}
