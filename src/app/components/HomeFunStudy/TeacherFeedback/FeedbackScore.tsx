import AverageInfo from "@/assets/img/home-fun-study/averageInfo.svg";
import ExcellentInfo from "@/assets/img/home-fun-study/excellentInfo.svg";
import FairInfo from "@/assets/img/home-fun-study/fairInfo.svg";
...
export function FeedbackScore({ score }: FeedbackScoreProps) {
  ...
  const getTeacherFeedbackByStudentScore = useCallback(
    (score: Score): TeacherFeedback => {
      switch (score) {
        case Score.POOR:
          return {
            icon: <PoorIcon />,
