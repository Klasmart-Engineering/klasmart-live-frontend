...
import {
    ...
    RoleResponse,
    UserInformation,
} from "./IUserInformationService";

// TODO (Axel): SOC: We may want to create a separate context for the authentication, to make the code easier to maintain and understand.
